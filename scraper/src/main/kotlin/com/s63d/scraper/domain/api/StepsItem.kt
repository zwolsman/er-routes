                     ...
                     val polyline: Polyline)
{
    ...
    fun toDatabaseModel() : com.s63d.scraper.domain.database.StepsItem {
        val points = decoder.decode(polyline.points).map {
            GeoJsonPoint(it.lng, it.lat)
        }
        val line = GeoJsonLineString(points)
        return com.s63d.scraper.domain.database.StepsItem(duration, startLocation.toGeoJsonPoint(), distance, travelMode, endLocation.toGeoJsonPoint(), line)
    }
}